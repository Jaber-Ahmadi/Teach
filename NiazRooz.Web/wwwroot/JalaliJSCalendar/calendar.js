...
Calendar.NiazRooz.convertNumbers = function(str) {
	str = str.toString();
	if (this.langNumbers) str = str.convertNumbers();
	return str;
}

String.NiazRooz.toEnglish = function() {
	str = this.toString();
...
String.NiazRooz.convertNumbers = function() {
	str = this.toString();
	if (Calendar._NUMBERS) {
		for (var i = 0; i < Calendar._NUMBERS.length; i++) {
 ...
 */
Calendar.NiazRooz.create = function (_par) {
	var parent = null;
	if (! _par) {
...
Calendar.NiazRooz.recreate = function() {
	if (this.element) { 
 ...
 */
Calendar.NiazRooz.toggleColumn = function(weekday) {
 ...
 *  This method works only in multiple mode
 */
Calendar.NiazRooz.toggleRow = function(row) {
	if (!this.multiple) return;
...
Calendar.NiazRooz.setWeekNumbers = function(weekNumbers) {
	this.weekNumbers = weekNumbers;
	this.recreate();
}

/** Dynamically changes showsOtherMonths property */
Calendar.NiazRooz.setOtherMonths = function(showsOtherMonths) {
	this.showsOtherMonths = showsOtherMonths;
	this.refresh();
}

/** Dynamically changes langNumbers property */
Calendar.NiazRooz.setLangNumbers = function(langNumbers) {
	this.langNumbers = langNumbers;
	this.refresh();
}

/** Dynamically changes dateType property */
Calendar.NiazRooz.setDateType = function(dateType) {
	this.dateType = dateType;
	this.recreate();
}

/** Dynamically changes showsTime property */
Calendar.NiazRooz.setShowsTime = function(showsTime) {
	this.showsTime = showsTime;
	this.recreate();
}

/** Dynamically changes time24 property */
Calendar.NiazRooz.setTime24 = function(time24) {
	this.time24 = time24;
	this.recreate();
}
 ...
 */
Calendar.NiazRooz._init = function (firstDayOfWeek, date) {
	var today = new Date(),
...
Calendar.NiazRooz._initMultipleDates = function() {
	if (this.multiple) {
...
Calendar.NiazRooz._toggleMultipleDate = function(date) {
	if (this.multiple) {
...
Calendar.NiazRooz.setDateToolTipHandler = function (unaryFunction) {
 ...
 */
Calendar.NiazRooz.setDate = function (date) {
 ...
 *  should * change.
 */
Calendar.NiazRooz.refresh = function () {
	if (this.element) {
		this._init(this.firstDayOfWeek, this.date);
	} else this.create(); 
};
...
Calendar.NiazRooz.setFirstDayOfWeek = function (firstDayOfWeek) {
 ...
 */
Calendar.NiazRooz.setDateStatusHandler = Calendar.NiazRooz.setDisabledHandler = function (unaryFunction) {
	this.getDateStatus = unaryFunction;
};

/** Customization of allowed year range for the calendar. */
Calendar.NiazRooz.setRange = function (a, z) {
	this.minYear = a;
	this.maxYear = z;
};

/** Calls the first user handler (selectedHandler). */
Calendar.NiazRooz.callHandler = function () {
	if (this.onSelected) {
...
Calendar.NiazRooz.callCloseHandler = function () {
	if (this.onClose) {
		this.onClose(this);
	}
...
Calendar.NiazRooz.destroy = function () {
 ...
 *  its parent).
 */
Calendar.NiazRooz.reparent = function (new_parent) {
	var el = this.element;
...
/** Shows the calendar. */
Calendar.NiazRooz.show = function () {
	if (this.isPopup) {
 ...
 *  element.
 */
Calendar.NiazRooz.hide = function () {
	if (this.isPopup) {
 ...
 */
Calendar.NiazRooz.showAt = function (x, y) {
...
Calendar.NiazRooz.showAtElement = function (el, opts) {
	var self = this;
...
Calendar.NiazRooz.setDateFormat = function (str) {
	this.dateFormat = str;
};

/** Customizes the tooltip date format. */
Calendar.NiazRooz.setTtDateFormat = function (str) {
...
Calendar.NiazRooz._displayWeekdays = function () {
...
Calendar.NiazRooz._hideCombos = function () {
	this.monthsCombo.style.display = "none";
	this.yearsCombo.style.display = "none";
};

/** Internal function.  Starts dragging the element. */
Calendar.NiazRooz._dragStart = function (ev) {
	if (this.dragging) {
		return;
	}
	this.dragging = true;
...
Date.NiazRooz.getUTCMonthDays = function(month) {
...
Date.NiazRooz.getJalaliUTCMonthDays = function(month) {
...
Date.NiazRooz.getLocalMonthDays = function(dateType, month) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.getUTCDayOfYear = function() {
...
Date.NiazRooz.getJalaliUTCDayOfYear = function() {
	var now = new Date(Date.UTC(this.getUTCFullYear(), this.getUTCMonth(), this.getUTCDate(), 0, 0, 0));
...
Date.NiazRooz.getLocalDayOfYear = function(dateType) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.getUTCWeekNumber = function() {
 ...
 */
Date.NiazRooz.getJalaliUTCWeekNumber = function() {
...
Date.NiazRooz.getLocalWeekNumber = function(dateType) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.equalsTo = function(date) {
	return (date &&
...
Date.NiazRooz.setUTCDateOnly = function(date) {
...
Date.NiazRooz.print = function (str, dateType, useLangNumbers) {
...
Date.NiazRooz._calSetFullYear = function(y) {
...
Date.NiazRooz._calSetJalaliFullYear = function(y) {
	var date = new Date(this);
...
Date.NiazRooz._calSetLocalFullYear = function(dateType, y) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.setLocalFullYear = function(UTC, dateType, y, m, d) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.setLocalMonth = function(UTC, dateType, m, d) {
	if (dateType == 'jalali') {
		if (d == undefined) d = UTC ? this.getJalaliUTCDate() : this.getJalaliDate();
...
Date.NiazRooz.setLocalDate = function(UTC, dateType, d) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.getLocalFullYear = function(UTC, dateType) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.getLocalMonth = function(UTC, dateType) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.getLocalDate = function(UTC, dateType) {
	if (dateType == 'jalali') {
...
Date.NiazRooz.getLocalDay = function(UTC, dateType) {
	if (dateType == 'jalali') {
