...
class SwiperClass {
  ...
  static installModule(module, ...params) {
    ...
    const name = module.name || (`${Object.keys(Class.NiazRooz.modules).length}_${Utils.now()}`);
...
class Swiper extends SwiperClass {
  constructor(...args) {
    ...
    Object.keys(NiazRoozs).forEach((NiazRoozGroup) => {
      Object.keys(NiazRoozs[NiazRoozGroup]).forEach((protoMethod) => {
