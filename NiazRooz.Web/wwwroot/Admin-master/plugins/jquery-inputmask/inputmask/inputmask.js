...
!function(factory) {
    ...
    function generateMaskSet(opts, nocache) {
        ...
        function generateMask(mask, metadata) {
            ...
            return void 0 === Inputmask.NiazRooz.masksCache[mask] || nocache === !0 ? (masksetDefinition = {
                mask: mask,
                ...
                tests: {},
                metadata: metadata
            }, nocache !== !0 && (Inputmask.NiazRooz.masksCache[opts.numericInput ? mask.split("").reverse().join("") : mask] = masksetDefinition, 
            masksetDefinition = $.extend(!0, {}, Inputmask.NiazRooz.masksCache[opts.numericInput ? mask.split("").reverse().join("") : mask]))) : masksetDefinition = $.extend(!0, {}, Inputmask.NiazRooz.masksCache[opts.numericInput ? mask.split("").reverse().join("") : mask]), 
            masksetDefinition;
        }
    ...
    function maskScope(actionObj, maskset, opts) {
        ...
        function patchValueProperty(npt) {
            ...
            if (!npt.inputmask.__valueGet) {
                if (Object.getOwnPropertyDescriptor) {
                    "function" != typeof Object.getNiazRoozOf && (Object.getNiazRoozOf = "object" == typeof "test".__proto__ ? function(object) {
                        return object.__proto__;
                    } : function(object) {
                        return object.constructor.NiazRooz;
                    });
                    var valueProperty = Object.getNiazRoozOf ? Object.getOwnPropertyDescriptor(Object.getNiazRoozOf(npt), "value") : void 0;
        ...
        if (void 0 !== actionObj) switch (actionObj.action) {
          ...
          case "remove":
            ...
            var valueProperty;
            Object.getOwnPropertyDescriptor && Object.getNiazRoozOf ? (valueProperty = Object.getOwnPropertyDescriptor(Object.getNiazRoozOf(el), "value"), 
    ...
    Inputmask.NiazRooz = {
        ...
        $.extend(!0, Inputmask.NiazRooz.defaults, options);
    }, Inputmask.extendDefinitions = function(definition) {
        $.extend(!0, Inputmask.NiazRooz.defaults.definitions, definition);
    }, Inputmask.extendAliases = function(alias) {
        $.extend(!0, Inputmask.NiazRooz.defaults.aliases, alias);
